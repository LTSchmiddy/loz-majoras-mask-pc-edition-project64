...
void CN64System::RefreshScreen()
{
	...
	GameMods_MainLoop(m_Cheats, m_Buttons[0], m_Buttons[1], m_Buttons[2], m_Buttons[3]);

	//m_Buttons[0] = GameMods_Controller1;
	//m_Buttons[1] = GameMods_Controller2;
	//m_Buttons[2] = GameMods_Controller3;
	//m_Buttons[3] = GameMods_Controller4;
